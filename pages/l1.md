...
Dans ce cas, voici le parcours que vous devez suivre. Les UE de math
et d’informatique sont obligatoires et une quatrième UE doit être
choisie entre électronique et physique. Par défaut, nous conseillons
le choix d’électronique.  Remarque : en validant ces quatre UE, vous
avez le choix de poursuivre en mathématique, informatique ou en
électronique (ou en physique pour ceux ayant choisi cette UE) . Aucun
prérequis n’est nécessaire pour suivre le cours de {% ue L1-BI-1 %}
qui consolide les bases à partir de zéro.
...
- 10 de moyenne générale en sciences.
